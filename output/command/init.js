...
var Init = /** @class */ (function () {
    ...
    Init.prototype.doInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var confs, tpls, promptList, tpl, namePrompt, projectName;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        confs = add_1.Add.getConf();
                        tpls = confs.map(function (item) { return ({
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.dc.getData(namePrompt)];
                    case 2:
                        projectName = _a.sent();
                        new create_1.Create(tpl.tpl, projectName.name);
                        return [2 /*return*/];
                }
            });
        });
